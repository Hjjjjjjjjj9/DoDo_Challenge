...
<style>
  *{margin:0;padding:0;}
  ...
  #slide li:nth-child(1){background:MediumAquaMarine;}
  #slide li:nth-child(2){background:PaleTurquoise;} 
  #slide li:nth-child(3){background:SteelBlue;}
...
<div id="slide" style="width: 100%; height: 18em; text-align:center; line-height: 4em;">
